          ...
          TextButton(
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (_) =>
                          DeleteAccountScreen(userId: _userId)));
            },
  ...
  Future<void> _confirmAndDelete() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
            'Bu amalni ortga qaytarib bo\'lmaydi. Akkauntingiz, mashinalaringiz '
            'va sevimlilar ro\'yxati butunlay o\'chiriladi. Davom etasizmi?'),
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(ctx, false),
              child: const Text('Bekor qilish')),
